			...
			)
{
	...
	std::vector<SeedL, cuda_allocator<SeedL>> cudaseeds(numAlignments);   // seeds vector using cudaMallocHost
	std::vector<SeedL, cuda_allocator<SeedL>> cudaseeds_r(numAlignments); // seeds vector using cudaMallocHost
